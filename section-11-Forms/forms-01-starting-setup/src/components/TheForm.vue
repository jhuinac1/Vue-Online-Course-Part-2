<template>
  <form @submit.prevent="submitForm">
    <div 
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="usernameInput"  @blur="validateInput"/>
    ...
    <div class="form-control">
      <input type="checkbox" id="confirm-temrs" name="confirm-terms" v-model="confirm">
      <label for="confirm-temrs"> Agree to terms of use? </label>
    </div>
    <div>
